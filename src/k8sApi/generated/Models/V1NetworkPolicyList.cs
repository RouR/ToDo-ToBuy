...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1NetworkPolicyList
    {
        /// <summary>
        /// Initializes a new instance of the V1NetworkPolicyList class.
        /// </summary>
        public V1NetworkPolicyList()
        {
            CustomInit();
        }
        ...
        public V1NetworkPolicyList(IList<V1NetworkPolicy> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
