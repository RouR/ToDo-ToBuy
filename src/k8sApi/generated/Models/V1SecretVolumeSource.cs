...
namespace k8s.Models
{
    ...
    public partial class V1SecretVolumeSource
    {
        ...
        public V1SecretVolumeSource(int? defaultMode = default(int?), IList<V1KeyToPath> items = default(IList<V1KeyToPath>), bool? optional = default(bool?), string secretName = default(string))
        {
