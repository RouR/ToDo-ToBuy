...
namespace k8s.Models
{
    ...
    /// master.
    /// </summary>
    public partial class V1NodeList
    {
        /// <summary>
        ...
        /// Initializes a new instance of the V1NodeList class.
        /// </summary>
        /// <param name="items">List of nodes</param>
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public V1NodeList(IList<V1Node> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1Node> Items { get; set; }
