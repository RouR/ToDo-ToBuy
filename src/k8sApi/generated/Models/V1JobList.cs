...
namespace k8s.Models
{
    ...
    public partial class V1JobList
    {
        ...
        public V1JobList(IList<V1Job> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        /// <summary>
        /// Gets or sets items is the list of Jobs.
        /// </summary>
