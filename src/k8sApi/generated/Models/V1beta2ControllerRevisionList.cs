...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1beta2ControllerRevisionList
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2ControllerRevisionList
        /// class.
        /// </summary>
        public V1beta2ControllerRevisionList()
        {
            CustomInit();
        }
        ...
        public V1beta2ControllerRevisionList(IList<V1beta2ControllerRevision> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1beta2ControllerRevision> Items { get; set; }
