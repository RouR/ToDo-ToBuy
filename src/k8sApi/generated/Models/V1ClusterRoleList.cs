...
namespace k8s.Models
{
    ...
    public partial class V1ClusterRoleList
    {
        ...
        public V1ClusterRoleList(IList<V1ClusterRole> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1ClusterRole> Items { get; set; }
