...
namespace k8s.Models
{
    ...
    public partial class V1beta1Subject
    {
        ...
        /// <param name="apiGroup">APIGroup holds the API group of the
        /// referenced subject. Defaults to "" for ServiceAccount subjects.
        /// Defaults to "rbac.authorization.k8s.io" for User and Group
        /// subjects.</param>
        ...
        /// <summary>
        /// Gets or sets aPIGroup holds the API group of the referenced
