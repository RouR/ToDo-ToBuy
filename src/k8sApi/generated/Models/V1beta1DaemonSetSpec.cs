...
namespace k8s.Models
{
    ...
    public partial class V1beta1DaemonSetSpec
    {
        ...
        public V1beta1DaemonSetSpec(V1PodTemplateSpec template, int? minReadySeconds = default(int?), int? revisionHistoryLimit = default(int?), V1LabelSelector selector = default(V1LabelSelector), long? templateGeneration = default(long?), V1beta1DaemonSetUpdateStrategy updateStrategy = default(V1beta1DaemonSetUpdateStrategy))
        {
