...
namespace k8s.Models
{
    ...
    public partial class V1ClusterRoleBindingList
    {
        ...
        public V1ClusterRoleBindingList(IList<V1ClusterRoleBinding> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
