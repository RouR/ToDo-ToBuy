...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1SubjectAccessReviewStatus
        /// class.
        /// </summary>
        public V1beta1SubjectAccessReviewStatus()
        {
            CustomInit();
        }
        ...
        public V1beta1SubjectAccessReviewStatus(bool allowed, string evaluationError = default(string), string reason = default(string))
        {
            Allowed = allowed;
