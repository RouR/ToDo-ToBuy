...
namespace k8s.Models
{
    ...
    public partial class V1PodCondition
    {
        ...
        public V1PodCondition(string status, string type, System.DateTime? lastProbeTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
