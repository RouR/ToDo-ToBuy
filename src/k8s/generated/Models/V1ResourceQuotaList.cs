...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1ResourceQuotaList
    {
        /// <summary>
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public V1ResourceQuotaList(IList<V1ResourceQuota> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
