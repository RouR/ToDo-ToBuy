...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1NetworkPolicyList class.
        /// </summary>
        public V1beta1NetworkPolicyList()
        {
            CustomInit();
        }
        ...
        public V1beta1NetworkPolicyList(IList<V1beta1NetworkPolicy> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1beta1NetworkPolicy> Items { get; set; }
