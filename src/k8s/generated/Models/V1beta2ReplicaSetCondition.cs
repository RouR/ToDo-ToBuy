...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class V1beta2ReplicaSetCondition
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2ReplicaSetCondition class.
        /// </summary>
        public V1beta2ReplicaSetCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public V1beta2ReplicaSetCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
