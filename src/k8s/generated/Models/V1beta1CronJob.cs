...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1CronJob class.
        /// </summary>
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public V1beta1CronJob(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), V1beta1CronJobSpec spec = default(V1beta1CronJobSpec), V1beta1CronJobStatus status = default(V1beta1CronJobStatus))
        {
        ...
        public V1beta1CronJobSpec Spec { get; set; }
        ...
        public V1beta1CronJobStatus Status { get; set; }
