...
namespace k8s.Models
{
    ...
    public partial class V1beta1Role
    {
        ...
        public V1beta1Role(IList<V1beta1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
