...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2Deployment class.
        /// </summary>
        public V1beta2Deployment()
        {
            CustomInit();
        }
        ...
        /// Deployment.</param>
        public V1beta2Deployment(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), V1beta2DeploymentSpec spec = default(V1beta2DeploymentSpec), V1beta2DeploymentStatus status = default(V1beta2DeploymentStatus))
        {
        ...
        public V1beta2DeploymentSpec Spec { get; set; }

        /// <summary>
        /// Gets or sets most recently observed status of the Deployment.
        /// </summary>
        [JsonProperty(PropertyName = "status")]
        public V1beta2DeploymentStatus Status { get; set; }
