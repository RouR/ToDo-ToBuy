...
namespace k8s.Models
{
    ...
    /// ones.
    /// </summary>
    public partial class V1beta2DeploymentStrategy
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2DeploymentStrategy class.
        /// </summary>
        public V1beta2DeploymentStrategy()
        {
            CustomInit();
        }
        ...
        public V1beta2DeploymentStrategy(V1beta2RollingUpdateDeployment rollingUpdate = default(V1beta2RollingUpdateDeployment), string type = default(string))
        {
        ...
        public V1beta2RollingUpdateDeployment RollingUpdate { get; set; }
