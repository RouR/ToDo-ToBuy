...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class V1beta2DeploymentCondition
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2DeploymentCondition class.
        /// </summary>
        public V1beta2DeploymentCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public V1beta2DeploymentCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), System.DateTime? lastUpdateTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
