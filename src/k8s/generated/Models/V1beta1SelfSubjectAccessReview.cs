...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1SelfSubjectAccessReview
        /// class.
        /// </summary>
        public V1beta1SelfSubjectAccessReview()
        {
            CustomInit();
        }
        ...
        public V1beta1SelfSubjectAccessReview(V1beta1SelfSubjectAccessReviewSpec spec, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), V1beta1SubjectAccessReviewStatus status = default(V1beta1SubjectAccessReviewStatus))
        {
        ...
        public V1beta1SelfSubjectAccessReviewSpec Spec { get; set; }
