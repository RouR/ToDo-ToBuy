...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class V1beta1StatefulSetCondition
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1StatefulSetCondition
        /// class.
        /// </summary>
        ...
        /// transition.</param>
        public V1beta1StatefulSetCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
