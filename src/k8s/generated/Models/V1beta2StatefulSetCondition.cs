...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class V1beta2StatefulSetCondition
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2StatefulSetCondition
        /// class.
        /// </summary>
        public V1beta2StatefulSetCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public V1beta2StatefulSetCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
