...
namespace k8s.Models
{
    ...
    public partial class V1alpha1Role
    {
        ...
        public V1alpha1Role(IList<V1alpha1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
