...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1ServiceList
    {
        /// <summary>
        ...
        /// Initializes a new instance of the V1ServiceList class.
        /// </summary>
        /// <param name="items">List of services</param>
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public V1ServiceList(IList<V1Service> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
