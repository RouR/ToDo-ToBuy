...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1beta2ReplicaSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the V1beta2ReplicaSetStatus class.
        /// </summary>
        public V1beta2ReplicaSetStatus()
        {
            CustomInit();
        }
        ...
        /// replica set.</param>
        public V1beta2ReplicaSetStatus(int replicas, int? availableReplicas = default(int?), IList<V1beta2ReplicaSetCondition> conditions = default(IList<V1beta2ReplicaSetCondition>), int? fullyLabeledReplicas = default(int?), long? observedGeneration = default(long?), int? readyReplicas = default(int?))
        {
        ...
        public IList<V1beta2ReplicaSetCondition> Conditions { get; set; }
