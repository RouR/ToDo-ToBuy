...
namespace k8s.Models
{
    ...
    public partial class V1beta1StatefulSetSpec
    {
        ...
        public V1beta1StatefulSetSpec(string serviceName, V1PodTemplateSpec template, string podManagementPolicy = default(string), int? replicas = default(int?), int? revisionHistoryLimit = default(int?), V1LabelSelector selector = default(V1LabelSelector), V1beta1StatefulSetUpdateStrategy updateStrategy = default(V1beta1StatefulSetUpdateStrategy), IList<V1PersistentVolumeClaim> volumeClaimTemplates = default(IList<V1PersistentVolumeClaim>))
        {
