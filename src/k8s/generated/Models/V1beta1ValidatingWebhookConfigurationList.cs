...
namespace k8s.Models
{
    ...
    public partial class V1beta1ValidatingWebhookConfigurationList
    {
        ...
        /// </summary>
        public V1beta1ValidatingWebhookConfigurationList()
        {
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets list of ValidatingWebhookConfiguration.
        /// </summary>
        [JsonProperty(PropertyName = "items")]
        public IList<V1beta1ValidatingWebhookConfiguration> Items { get; set; }
